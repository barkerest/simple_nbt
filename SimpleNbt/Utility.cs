...
namespace SimpleNbt
{
	public static class Utility
	{
		...
		private static readonly INamedBinaryTagConverter[] DefaultConverters =
		{
			...
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, List<short>>(nm => new ListTag<ShortTag>(nm), v => v.ToList()),
			...
			// additional converters after the tag defaults.
			...
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, short[]>(nm => new ListTag<ShortTag>(nm), v => v.ToArray()),
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, ushort[], ushort>(nm => new ListTag<ShortTag>(nm), v => v.ToArray(), v => unchecked((ushort) v), v => unchecked((short) v)),
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, List<ushort>, ushort>(nm => new ListTag<ShortTag>(nm), v => v.ToList(), v => unchecked((ushort) v), v => unchecked((short) v)),
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, IEnumerable<short>>(nm => new ListTag<ShortTag>(nm), v => v),
			new SimpleListConverter<ListTag<ShortTag>, ShortTag, short, IEnumerable<ushort>, ushort>(nm => new ListTag<ShortTag>(nm), v => v, v => unchecked((ushort) v), v => unchecked((short) v)),
